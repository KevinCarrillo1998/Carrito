    ...
    <nav class="navbar is-light" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
            <a class="navbar-item" href="">
               <!-- <img alt="" src="https://logodownload.org/wp-content/uploads/2014/07/adidas-logo-branco.png" width="80" height="30" />-->
            </a>
        ...
        <div class="navbar-menu">
            ...
            <div class="navbar-end">
                <div class="navbar-item">
                    <div class="is-large">
                        <a href="ver_carrito.php" class="button is-link is-rounded is-outlined">
                            <strong>Carrito<?php
